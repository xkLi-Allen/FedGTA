...
parser.add_argument('--name', help='data name', type=str, default="PubMed")                     # CiteSeer, PubMed
...
parser.add_argument('--moment_type', help='type of moments', type=str, default="origin")        # citeseer: hybrid  pubmed: origin
parser.add_argument('--num_moments', help='order of moments', type=int, default=13)             # citeseer: 20      pubmed: 13
parser.add_argument('--gm_alpha', help='gm alpha', type=float, default=0.65)                    # citeseer: 0.60    pubmed: 0.65
