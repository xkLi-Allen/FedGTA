...
parser.add_argument('--name', help='data name', type=str, default="Cora")
...
parser.add_argument('--moment_type', help='type of moments', type=str, default="hybrid")
parser.add_argument('--num_moments', help='order of moments', type=int, default=6)
parser.add_argument('--gm_alpha', help='gm alpha', type=float, default=0.50)
